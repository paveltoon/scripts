...
for(var i in Object.keys(oktmos)){
      var upd = db.claims.update(
        {
            "oktmo": "55555555",
            "activationDate": {
                $gte: ISODate("2019-12-11T21:00:00.000+0000")
            },
            ...
            "creatorDeptId": Object.keys(oktmos)[i]
        },{
            $set:{
                "oktmo": oktmos[Object.keys(oktmos)[i]]
            }
        },
        {
            multi: true
    ...
    count += upd.nModified;
    print(Object.keys(oktmos)[i] + ': ' + upd.nModified + ' / ' + upd.nMatched) 
}
